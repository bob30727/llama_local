...
Step 1: Determine whether the sentence needs to be split. If it contains multiple sentences, split them and using [@timestamp_begin] mark the verbs in each sentence. 
For example: 
...
if __name__ == "__main__":
    test_sentence = "If you have any questions, feel free to ask. Thank you for visiting, and have a great day!"
    main(test_sentence)