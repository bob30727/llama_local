...
###STEP1### Can I [@timestamp_begin]show you something specific today?
...
if __name__ == "__main__":
    test_sentence = "I’m sorry, but it seems there’s a system issue at the moment. Let me quickly resolve that for you."
    main(test_sentence)